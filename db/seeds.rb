...
countries = [
  ...
  {name: "United States", code: "US", alt: "united states of america"},
...
countries.each do |country|
  ...
  params = {
    ...
    titles: country[:name], # Replace with the title you're searching for
  ...
  # if country_flag.nil? == false
    place = Country.create(name: country[:name], flag_url: country_flag ? country_flag : nil, code: country[:code].downcase, alt: country[:alt] ? country[:alt] : country[:name].downcase)
  # else
